...
Code for the work "Interpretability Benchmark for Evaluating Spatial Misalignment of Prototypical Parts Explanations"

Arxiv version of the paper: https://arxiv.org/abs/2308.08162

Please refer to the description of the `main.py` script for training, and the `run_adversarial_test.py` script for running the spatial alignment test.


The repository is fork of: https://github.com/cfchen-duke/ProtoPNet with our custom changes. It also includes the repository: https://github.com/gmum/ProtoPool.
